...
export const Sidebar = () => (
  <div id="sidebar1" class="sp-part-top sp-sidebar">
    <div id="sp-button-1" class="sp-part-top sp-button"><a href="https://ameblo.jp/teamorion/?frm_id=v.mypage-ameblo--myblog--blog">ブログ</a></div>
    ...
    <div id="sp-sns-button-1" class="sp-part-top sp-sns-button">
      <ul>
        ...
        <li><a href="https://twitter.com/share" class="twitter-share-button" data-count="horizontal" data-lang="ja">Tweet</a><script type="text/javascript" src="https://platform.twitter.com/widgets.js" charset="utf-8"></script></li>
