    ...
    <div id="main" className="site-main sp-part-top sp-main">
      ...
      <div id="main-inner">
        <div id="primary" className="content-area">
          <div id="content" className="site-content sp-part-top sp-content page-custom" role="main">
            <header id="sp-page-title-10" className="entry-header sp-part-top sp-page-title">
              <h1 className="entry-title">商品紹介</h1>
            </header>
            <article>
              <div id="page-content" className="sp-part-top sp-block-container">
                <h1 className="paragraph"><span className="character" style={{color : "#1c1c64"}}>『ラ・プレシア シリーズ』</span></h1>
                <h1 className="paragraph"><span className="character" style={{color : "#ce3348"}}>ラ・プレシア　デュー</span></h1>
                <p className="large paragraph"><b className="character" style={{color : "#004000"}}>○プラセンタデュー100</b>　【プラセンタ美容液】</p>
                <p className="paragraph"><br />
                プラセンタとは胎盤のことで、胎児の発育に必要不可欠な組織と言われています。</p>
                <p className="paragraph">プラセンタエキスは、この組織から抽出した天然美容液です。</p>
                <p className="paragraph">プラセンタエキスには10個もの美容効果があり、どんなお肌の方にも最適な多機能天然原液。</p>
                <p className="paragraph">多くの有効成分と成長因子の働きにより、細胞レベルで美肌に導きます。<br /></p>
                <p className="paragraph">30ml ￥9,000(税別)<br /></p>
                ...
                <p className="paragraph">【プラセンタエキス　配合二層式ローション】<br />
                ...
                <p className="large paragraph"> </p>
                <p className="large paragraph"><b className="character" style={{color : "#004000"}}>○ラ・プレシア　クリーム U</b></p>
                <p className="large paragraph"> </p>
                <p className="paragraph">【プラセンタエキス　配合クリーム】<br />
                吸いつくような保湿感とともにキメのひとつひとつを整え、</p>
                <p className="paragraph">ハリと弾力のある、乾燥知らずのお肌に整えます。</p>
                <p className="paragraph"><br />
                31g　￥8,500(税別)<br /></p>
                <p className="paragraph">■使用方法<br />
                ...
                <p className="paragraph"> </p>
                <p className="paragraph">【プラセンタエキス　配合クリーム】<br /></p>
                <p className="paragraph">吸いつくような美容成分がしっかりと潤いを与え、自らの持つ力でハリと弾力のあるお肌に整えます。<br /></p>
                <p className="paragraph"> </p>
                <p className="paragraph">30g　￥10,000(税別)<br /></p>
                <p className="paragraph"> </p>
                <p className="paragraph">■使用方法<br />
                ...
                <p className="large paragraph"> </p>
                <p className="large paragraph"><b className="character" style={{color : "#004000"}}>○ソレ　サンアウト32</b><br /></p>
                <p className="paragraph"> </p>
                <p className="paragraph">【日焼け止めクリーム】<br />
                プラセンタエキス※配合で保湿しながらＵＶケア。</p>
                <p className="paragraph">汗・水に強く、さらに白浮きを防ぎ、毛穴もカバーでき化粧下地に最適です。</p>
                <p className="paragraph">お肌にやさしい低刺激タイプ。</p>
                <p className="paragraph"><br />
                30g　￥3,500(税別)<br /></p>
                <p className="paragraph"> </p>
                <p className="paragraph">■使用方法<br />
                ...
                <p className="paragraph">『ラ・プレシア ヴェール』は、素肌の喜ぶことを追求し続けるという発想で、スキンケアだけではなく</p>
                <p className="paragraph">ファンデーションにまでこだわることで真の素肌を手に入れられるとの考えから開発されました。</p>
                <p className="paragraph">肌がキレイな人を見るたび、羨ましくなる。鏡を見るたび、自分の肌が嫌いになる。</p>
                <p className="paragraph">そんな女性の思いや悩みを少しでも解決したいというファンデーションです。</p>
                <p className="paragraph">スキンケア発想だけに、ツボを押しながら塗布しリンパに流す手法で、</p>
                <p className="paragraph">ケアしながらメイクできる一石二鳥の仕様となっています。</p>
                <p className="paragraph"><b className="character" style={{color : "#2d2d9f"}}>※プラセンタエキス配合</b></p>
                <p className="paragraph"> </p>
                <p className="paragraph"><b className="character" style={{color : "#ce3348"}}>☆ラ・プレシア　ヴェール リキッドファンデーション</b><br /></p>
                <p className="paragraph">　　【水溶性ファンデーション】　　25g　￥3,500(税別)<br /></p>
                <p className="paragraph"> </p>
                <p className="paragraph">　○　通気性に優れ、軽い仕上がり</p>
                <p className="paragraph">　○　つけた瞬間から肌のハリ感、リフティングを実感</p>
