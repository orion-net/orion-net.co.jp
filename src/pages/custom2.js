    ...
    <div id="main" className="site-main sp-part-top sp-main">
      ...
      <div id="main-inner">
        <div id="primary" className="content-area">
          <div id="content" className="site-content sp-part-top sp-content page-custom2" role="main">
            <header id="sp-page-title-11" className="entry-header sp-part-top sp-page-title">
            ...
            <article>
              <div id="page-content" className="sp-part-top sp-block-container">
                ...
                この機会にぜひお買い求めくださいませ。<br /><br /><b className="character" style={{color : "#2d2d9f"}}>セット料金　￥３.９６０</b><br /><br /><br />
                ※ボディーソープが付いたセットはなくなり次第終了となります。<br />
                ※シャンプー、コンディショナーは単品でも販売しております。<br />
                （ボディーソープのみの販売はしておりません）<br /><br /><br /><br /><br /><b className="character" style={{color : "#f04a42"}}>〇ミントベル　アイランドピンクシャンプー</b><br /><br /><span className="character" style={{color : "#2d2d9f"}}>単品　￥１.680</span><br /><br />
                ...
                華やかなサニーハイビスカスの香りが漂います。<br /><br /><br /><br /><br /><b className="character" style={{color : "#f04a42"}}>〇ミントベル　スキャルプコンディショナー</b><br /><br /><span className="character" style={{color : "#2d2d9f"}}>単品　￥2.280</span><br /><br />
                天然メントール（涼感成分）配合で頭皮に爽快感とうるおいを与え、</p>
                <p className="large paragraph">さらっとした髪に仕上げます。<br /><br />
                センブリエキス（保湿成分）やホホバ種子油（保湿成分）、</p>
                <p className="large paragraph">保湿成分であるシアバター（シア脂）、<br /><br />
                カキタンニン（毛髪保護成分）を配合。<br /><br />
                シトラスフローラルフルーティーの香り。<br /><br /><br /><b className="character" style={{color : "#f04a42"}}>〇ミントベル　ボディーソープ</b><br /><br /><br />
                天然メントール（涼感成分）配合でスッキリ爽快な洗い上がり。<br /></p>
                <p className="large paragraph">ヒアルロン酸（保湿成分）とグレープフルーツ果実エキス（保湿成分）配合で、<br /></p>
                <p className="large paragraph">うるおいとしっとり感を。<br /></p>
                <p className="large paragraph">グレープフルーツとミントの香り。</p>
                <p className="large paragraph"> </p>
                <p className="large paragraph"> </p>
                <p className="large paragraph"> </p>
                <p className="large paragraph"> </p>
                ...
                <p className="paragraph"> </p>
                <p className="large paragraph" style={{color : "#df5300"}}><b className="character">フィトリーク</b></p>
                <p className="paragraph">＜肌と髪の保湿ローション＞<br /></p>
                <p className="paragraph"> </p>
                <p className="large paragraph">天然オイルと美容液配合で、髪の内部から潤ってサラサラに</p>
                <p className="large paragraph">香りも豊かで華やか<br />
                天然植物オイルなので肌にも使用できます<br /></p>
                <p className="large paragraph"> </p>
                <p className="large paragraph" style={{color : "#2d2d9f"}}><b className="character">☆特徴</b>　<br /></p>
                <p className="paragraph"> </p>
                <p className="large paragraph"><span className="character" style={{color : "#d85a6a"}}>〇２層式だからできるワンステップでダブルトリートメント</span><br /></p>
                <p className="paragraph">従来のオイルトリートメントには配合することの出来なかった、水溶性の保湿・補修成分(美容液成分)を配合。髪の内部と表面を同時にトリートメントします。<br />
                ※髪の内部補修と表面保護<br /></p>
                <p className="paragraph"> </p>
                <p className="large paragraph"><span className="character" style={{color : "#ce3348"}}>〇肌にも使用できる贅沢な処方</span><br /></p>
                <p className="paragraph">天然植物オイル、美容液成分配合。パラペンフリー。</p>
                <p className="paragraph">髪はもちろん肌に対しても使用できる保護ローションです。<br /></p>
                <p className="paragraph"> </p>
                <p className="large paragraph" style={{color : "#ce3348"}}>〇だから、ハイブリッドに使える<br /></p>
                <p className="paragraph">髪になじませた後の手に残ったトリートメントは、手・腕・ひじ等、お肌の乾燥が気になる部分へ</p>
                <p className="paragraph">ボディーローション（保湿ローション）として使用出来るハイブリッドユース。</p>
                <p className="paragraph">手を洗う必要はありません。<br /></p>
                <p className="paragraph"> </p>
                <p className="large paragraph"><span className="character" style={{color : "#ce3348"}}>〇フローラル　アンバリーの神秘的なフレグランス</span><br /></p>
                <p className="paragraph">手に取った瞬間、はじけるシトラスの爽やかさ。<br />
                時間とともにフローラル、そして大人の女性をイメージさせるアンバーへと変化。濃厚な花の香りと神秘的な香りが出会った華やかで豊かな香りです</p>
                <p style={{color : "#4b4bcd"}} className="paragraph"><br /><span className="character" style={{color : "#2d2d9f"}}>ブルー　　：天然植物オイル</span><br /><span className="character" style={{color : "#ff701a"}}>オレンジ　：美容液成分</span><br /></p>
                <p className="paragraph"> </p>
                <p className="large paragraph"><b className="character" style={{color : "#2d2d9f"}}>☆使い方　</b></p>
                ...
                <p className="large paragraph">　ボディーローション(保護ローション)としてご使用ください。<br /></p>
                <p className="paragraph"> </p>
                <p className="large paragraph"><b className="character" style={{color : "#2d2d9f"}}>☆効果</b><br /></p>
                <p className="paragraph"> </p>
                <p className="large paragraph">デュアル　モイスト効果で芯まで長時間うるおって柔らかく。<br />
                髪内部へ浸透した美容液成分をオイルトリートメントが包み込む</p>
                <p className="large paragraph">デュアルモイスト効果によって、</p>
                <p className="large paragraph">内部からの水分蒸発を抑え、潤いを長時間持続させます。<br /></p>
                <p className="large paragraph"> </p>
                <p className="paragraph"> </p>
                <p className="paragraph"> </p>
                <p className="paragraph"> </p>
                ...
                <p className="paragraph"> </p>
                <p className="large paragraph" style={{fontSize : "1.6rem", color : "#ececec"}}><b className="character" style={{color : "#df5300"}}>Ｆ.プロテクト フォルムキーパー</b></p>
                <p className="paragraph">＜洗い流さないヘアトリートメント＞</p>
                <p className="paragraph"> </p>
                <p className="large paragraph">サロンでケアした、カラー・パーマ後のフォルムをさらに美しく、</p>
                <p className="large paragraph">長時間キープさせる洗い流さないタイプのトリートメントです</p>
                <p className="paragraph"> </p>
                <p className="paragraph"> </p>
                <p className="large paragraph"><b className="character" style={{color : "#2d2d9f"}}>☆特徴</b></p>
                <p className="paragraph"> </p>
                <p className="large paragraph">〇ダメージによって失われた髪の細胞の補修・保護</p>
                <p className="large paragraph">〇紫外線によるカラーの褐色を抑える</p>
                <p className="large paragraph">〇コスメ系薬剤の残臭を抑える</p><br /><br />
                <p className="large paragraph"><b className="character" style={{color : "#2d2d9f"}}>☆使用方法</b></p>
                <p className="paragraph"> </p>
                <p className="large paragraph">〇ダメージによって失われた髪の細胞の補修・保護</p>
                <p className="large paragraph">〇ハーフドライの状態(ドライ後でも使用可)の髪に適量をなじませた後、</p>
                ...
                230ｇ/3,500円（税抜）<br /><br /><b className="character">○炭酸効果で血行促進させながらお肌に負担をかけることのない</b><br /><b className="character">機能性炭酸洗顔で</b><b className="character">す</b><br /><br /></p>
                <p className="large paragraph" style={{color : "#2d2d9f"}}><b className="character" style={{color : "#004000"}}>●洗顔の基本は泡</b><br /></p>
                <p className="large paragraph" style={{color : "#7d5b4f"}}>泡洗顔とは、肌に摩擦を与えずに手と肌の間で泡を転がすようにして洗う洗顔です。<br />
                ...
                朝の寝起きにリフレッシュマッサージとして、１日の終わりに疲れを癒すリンパマッサージやパックとして、洗顔だけで多機能性の高い洗顔フォームです。<br /><br /><b className="character" style={{color : "#004000"}}>●30秒の効果の理由</b><br /></p>
                <p className="large paragraph">炭酸の効果は、入浴剤で例えると20分以上炭酸に浸かることで効果はが得られます。<br />
                ...
                <p className="large paragraph">クマやくすみなども肌のトーンを暗く見える原因となる血行不良が原因ですので、血行促進＆新陳代謝を促進させることによりお肌のトーンを明るくさせてくれます。<br /></p>
                <p className="large paragraph">炭酸の力は、ニキビ・吹き出物といった老廃物を除去してくれる効果もあります。思春期の肌や大人のニキビ肌にもオススメです。<br /></p>
                <p className="large paragraph"> </p>
                <p className="large paragraph"> </p>
                <p className="large paragraph" style={{color : "#ce3348"}}><strong className="character" style={{color : "#d85a6a"}}>［使い方］</strong><br /></p>
                <p className="large paragraph" style={{color : "#ce3348"}}><span className="character" style={{color : "#2d2d9f"}}>ピンポン玉くらいの量を手に取り、顔全体に泡を広げて、泡で顔を包み込むようにして泡を塗布します。</span><br /></p>
                <p className="large paragraph" style={{color : "#2d2d9f"}}>30秒ほどおいていただくとパック効果となります。</p>
